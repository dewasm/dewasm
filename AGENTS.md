...
- Each backend's lowering shapes are fixed; follow them rather than restructuring in passing. They are recorded per backend: Ruby decisions 4/18/42-44/58/60/65/72/75/76/78/79, Bash decisions 5/11-13/34/35/51/52, Python decisions 18/28/75/76/78/79, Go decisions 18/29, Java decisions 18/30, Perl decisions 18/55.
