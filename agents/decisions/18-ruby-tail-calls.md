...
Implemented: `crates/dewasm-core/src/{ir,func,module}.rs`, `crates/dewasm-backend/src/lib.rs` (`stmts_use_tail_calls`), `crates/dewasm-backend-{ruby,python,perl}/src/lib.rs`, and each of their `units/rt/tail_call.*` and `units/table/tail_ref.*`.
