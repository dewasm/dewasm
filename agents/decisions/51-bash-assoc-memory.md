...
Criterion: *representation choices in the Bash runtime are judged on asymptotic access pattern at real-module scale, not on small-module microbenchmarks* — per-element hash overhead makes tiny sequential benches slightly slower, and that is acceptable.
