...
;;
;; One iteration is a dependency chain of mul / add / xor / shift / rotl on
;; i32, so the measurement is integer-op dispatch cost and nothing else: no
;; memory traffic, no calls, one branch per iteration.
;;
;; ---------------------------------------------------------------------------
