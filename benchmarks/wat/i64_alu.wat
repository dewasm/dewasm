...
;;
;; The i32_alu chain widened to i64.
;; The pair isolates the cost a backend pays for 64-bit values: the Ruby/Python/Perl backends carry i64 in the host's bignum-capable integer type, so the ratio against i32_alu is the interesting number.
;;
;; ---------------------------------------------------------------------------
;; Shared preamble.
