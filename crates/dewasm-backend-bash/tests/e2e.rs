...
// / pcap_compile_e2e!: not invoked — Bash has no host-language C API to plumb a
// pointer-returning binding through (ADR-12), and (pcap/sqlite) the multi-MB
// reactor artifacts are far past what Bash's parser can load in practice.
