...
# SYMLINK_FOLLOW) must hardlink the link itself. linkat(..., 0) is nofollow on every POSIX.1-2008 platform, so bind it via Fiddle; returns 0 on success or the errno on failure.
