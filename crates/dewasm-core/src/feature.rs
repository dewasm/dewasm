...
impl Feature {
    ...
    /// Validator feature bits that this proposal tests, for attributing validation failures. `None` for capabilities that validate fine under the base feature set and are rejected during IR building.
