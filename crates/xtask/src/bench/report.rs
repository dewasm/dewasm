...
pub fn render_doc(report: &Report, charts: &[Chart]) -> String {
    ...
    out.push_str("<!-- AUTO-GENERATED by `cargo xtask render-speed`; do not edit by hand. Unlike docs/support.md there is no freshness test: timings are not reproducible byte-for-byte, so this file is a dated measurement, not a compared snapshot. -->\n\n");
