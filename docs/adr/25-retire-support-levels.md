...
- **Keep the levels** — collapses as described; also forces every new test case to be level-classified, which ADR-23's own experience showed goes wrong when done by guesswork instead of execution.
