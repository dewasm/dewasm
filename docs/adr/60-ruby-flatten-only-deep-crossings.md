...
ADR-58's own motivation was the opposite shape — sqlite's VDBE, where a `br_table` crosses hundreds of frames and the relay's per-level compares dwarf one dispatch.
