...
# agnes pinned at its latest commit; agnes.h/agnes.c fetched as raw blobs, each
# sha256-pinned.
...
# The demo ROM: Alter Ego by Shiru, released into the public domain. The zip
# carries the .nes alongside label art / a manual; only the ROM is extracted.
