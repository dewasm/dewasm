#!/usr/bin/env bash
# Regenerate the dewasm-generated DOOM library and syntax-check the frontend. doom_gen.rb is ~11MB of generated code and is gitignored, so this step has to run before main.rb can require it from a clean checkout.
