#!/usr/bin/env bash
# Regenerate the dewasm-generated NES library and syntax-check the
# frontend. nes_gen.rb is generated code and is gitignored, so this step
# has to run before main.rb can require it from a clean checkout.
