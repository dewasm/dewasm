;; Per-fd rights enforcement: every probe prints "<tag><errno as two decimal digits>\n" so the expected stdout pins each errno exactly.
...
(module
  ...
  (func (export "_start")
    ...
    ;; t: O_TRUNC (oflags 0x8) without PATH_FILESTAT_SET_SIZE is NOTCAPABLE, and must not truncate the host file.
