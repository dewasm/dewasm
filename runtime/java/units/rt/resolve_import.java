...
// names itself (ADR-7); the parameter is wildcarded so both a
// `Map<String, Map<String, Object>>` and a mixed `Map<String, Object>` are
// accepted. Returns null when the module, or the name within it, is absent, so
// the caller falls through to its bundled-WASI / ENOSYS / link-error fallback.
