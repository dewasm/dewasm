...
sub wasi_path_rename {
    ...
    # The preserved slash lets the host rename(2) enforce the existing and missing shapes; a *nonexistent* slash-suffixed destination is stripped so the rename proceeds, as wasmtime does (issue #42).
