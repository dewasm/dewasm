...
# Rights a regular-file fd may carry, and the two directory masks. A
# directory fd's base is narrowed to DIR_BASE_RIGHTS (so a requested FD_SEEK
# or FD_WRITE is dropped rather than granted), and its inheriting rights add
# the file rights it may pass to children (DIR_INHERITING_RIGHTS). These
# mirror the fixed masks wasi-common applies at path_open.
